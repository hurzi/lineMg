                                  ...
                                  <div class="form-body">
                                    <h4 class="form-section">基本信息</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="topic_title" id="topic_title" value="测试001">
                                                <span class="help-block">题目，50字以内</span>
                                                <span class="help-block" id="onlyone" style='color:red;'></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">提示<span class="required" aria-required="true"> * </span></label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="topic_tip" id="topic_tip" value="测试001">
                                        ...
                                        <div class="form-group pointBoxDiv">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="topic_point" id="topic_point" value="">
...
$(function () {
	...
	$("#submit").click(function(){
		...
		var setUrl = "<?php echo url('ZgykdxEvaluating', 'ajax_addEvaluatingTopic');?>";

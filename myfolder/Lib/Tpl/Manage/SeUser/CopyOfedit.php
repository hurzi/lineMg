...
<div class="bodyTitle">
	...
	<div class="bodyTitleText">编辑管理员</div>
...
<form method="post" action="#" onsubmit="" name="form1">
	<table width="100%">
		<tr>
			...
			<td>
				<input size="32" name="username" type="text" class="txt" id="username" value="<?php echo $operator['username'];?>" />
		...
		<tr>
			...
			<td>
				<input size="32" name="nickname" type="text" class="txt" id="nickname" value="<?php echo $operator['nickname'];?>" />
				<strong class="cr"> * </strong>
		...
		<tr>
			...
			<td>
				...
				<label for="password">重置密码为(123456)</label>
		...
		<tr>
			...
			<td>
				...
				<input type="button" name="Submit2" value="编辑管理员" class="inputButton" id="submit" />
...
$(function (){
	...
	var url = "<?php echo url('EntSuperAdmin', 'update');?>";
...
function checkSubmit(url, href){
	...
	if (username == null || username == ''){
		showmsg('username_prompt', '管理员ID不能为空');
		return false;

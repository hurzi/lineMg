				...
				<TBODY>
					<tr>
						<td width="120" class="tr">
							<span>
								<label for="image_title">图片标题:</label>
							</span>
						</td>
						<td>
							<input type="text" id="image_title" style="width: 305px" />
							<bt class="hui">(必填)</bt>
						</td>
					</tr>
					<tr>
						<td class="tr">
							<span>
								<label for="nickname">图片上传:</label>
							</span>
						</td>
						<td>
							<div style="width: 309px;" class="cover-area">
								<div class="oh z cover-hd">
									<iframe src="./UploadImg/Upload.php?callback=uploadImg&max_size=<?php echo $maxSize;?>"
										class="uploadfile"
					...
					<tr>
						<td></td>
						<td>
							<a onclick="qrOk();" href="javascript:void(0);" class="button blue medium">提交</a>
						</td>
					</tr>
				</TBODY>
			</TABLE>
...
<script type="text/javascript">
		var url = "<?php echo url('MaterialImage', 'insert');?>";

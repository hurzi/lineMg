<?php tpl("Common.header_1")?>
				...
				<TABLE cellpadding="0" cellspacing="0" class="t">
					...
					<TBODY>
							...
							<td>
								<select id="pid" class="add_input"  style="width:167px">
				              	...
				              	<?php foreach($groupList as $k => $v ){ ?>
									<option value="<?php echo $v['ug_id']; ?>"><?php echo $v['ug_name']; ?></option>
				              	<?php }?>
				                </select>
						...
						<tr>
							...
							<td>
								<input type="text" id="name" class="add_input" />
								<bt class="hui">(必填)</bt>
							</td>
						</tr>
	...
	<script type="text/javascript">
		var url = "<?php echo url('UserGroup', 'insert');?>";

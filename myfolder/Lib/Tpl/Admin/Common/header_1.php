...
<!--单图文-->
<script type="text/javascript" src="./Public/js/WxFace/wxFace.js?v=<?php echo VERSION;?>"></script>
...
<script type="text/javascript" src="./Public_1/cj/MsgEditor/messageEditor.js?v=<?php echo VERSION;?>"></script>
<script type="text/javascript" src="./Public_1/cj/ueditor/editor_all_min.js?v=<?php echo VERSION;?>"></script>
<script type="text/javascript" src="./Public_1/cj/ueditor/editor_config.js?v=<?php echo VERSION;?>"></script>
<!-- 选择图文 -->
<script type="text/javascript" src="./Public_1/js/massMessage.js?v=<?php echo VERSION;?>"></script>
<script type="text/javascript" src="./Public_1/js/timing.js"></script>
...
<script type="text/javascript" src="./Public_1/js/area.js?v=<?php echo VERSION;?>"></script>

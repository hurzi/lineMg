<?php tpl("Common.header_1")?>
			...
			<div class="con_edit">
				<table cellpadding="0" cellspacing="0" class="t">
					...
					<tbody>
						<tr>
							<td width="120">
								<span><label for="truthname">马甲名称:</label></span>
							</td>
							<td>
								<input type="text"  class="add_input" name="truthname" id="truthname" value="<?php echo $userinfo['truthname'];?>"/>
								<bt class="hui">(必填)</bt>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div style="width: 309px;" class="cover-area">
									...
									<p class="cover-bd" id="imgArea" >
										<img width="309" id="img" src="<?php echo $userinfo['headimgurl'];?>">
	...
	<script type="text/javascript">
		var url = "<?php echo url('RegistUser', 'update');?>";

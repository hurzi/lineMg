...
<body>
  ...
  <div class="M_content" style="padding-top:60px;">
        ...
        <h3 class="user_xy color_t_Green" style="margin-bottom: 10px;text-align: center;">温馨提示：48小时后须再次确认</h3>
        
       <!-- <p class="user_xy" >温馨提醒：48小时之内，您只能使用一次解锁功能!</p>-->
        <p style="font-size: 12px;text-align: center;">解锁后，再次成功锁定的一方，原私信收信箱</br>数据全部清空，请谨慎操作！</p>

...
$phone = '15101019215';
$content = '【红牛饮料】验证码为12345,10分钟后失效';
if(isset($data['phone'])){
	$phone = $data['phone'];
}
 ...
 * 序列号,请通过亿美销售人员获取
 */
$serialNumber = '9SDK-EMY-0999-JCXRR';
...
// getVersion();      //得到版本号  
// setMOForward();    //注册转接服务  
// sendSMS($phone,'您的验证码是：324234【红牛饮料】');         //发送短信
 ...
 * 短信发送 用例
 */
function sendSMS($phone='15101019215',$content='验证') {
	global $client;
	/**
...
function setMOForwardEx() {
	 ...
	 * 以数组形式填写手机号码
	 */
	$statusCode = $client->setMOForwardEx ( array ('159xxxxxxxx', '159xxxxxxxx', '159xxxxxxxx' ) );
	echo "处理状态码:" . $statusCode;
}

...
class WX_OAuthToken
{
	...
	public $openId;
	public $expiresIn;
	public function __construct($accessToken, $openId, $refreshToken=null,$expiresIn=null){
...
class WX_Token {
    ...
    public function __construct($token, $expires_in, $refresh_token = null)
    {
        $this->token = $token;
...
class WX_Message
{
    ...
    public function __construct($message_id, $msgType, $fromUser, $created_at,$toUserName)
    {
...
class WX_Message_Body
{
    ...
    /**
     * 消息类型
     * 六种类型：text-文本|image-图片|voice-语音|video-视频|link-链接|news-图文消息|card互通卡券
     * @var string
     */
    public $type;
    /**
...
class WX_Componect_Message
{
	...
	/**
	 * 根据infoType来组装不同的参数，该值为key-value形式
	 * @var unknown
	 */
	 ...
	 * 构造函数
	 */
	public function __construct($appid,$infoType,$createAt){
		$this->appid = $appid;

 ...
 *  date 2013-01-04
 */
include_once ABC_PHP_PATH . '/DB/DB.class.php';
class MySql extends DB
{
	...
	{
		parent::__construct($host, $user, $password, $dbname, $connect = false, $charset = 'utf8');
		
		$this->logDir = AbcPHPConfig::getSqlLogDir();
		$this->logSql = AbcPHPConfig::get('ENABLE_SQL_LOG');
		//初始化log file
		$this->iniLogConfig();
	}

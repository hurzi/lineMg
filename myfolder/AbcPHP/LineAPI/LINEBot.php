...
define("LINE_API_PATH", dirname(__FILE__));
include_once LINE_API_PATH . '/LINEBot/HTTPClient/HTTPClient.php';
include_once LINE_API_PATH . '/LINEBot/HTTPClient/LineHTTPClient.php';
//include_once LINE_API_PATH . '/LINEBot/HTTPClient/GuzzleHTTPClient.php';
include_once LINE_API_PATH . '/LINEBot/Constant/BotAPIChannel.php';
include_once LINE_API_PATH . '/LINEBot/Constant/EventType.php';
include_once LINE_API_PATH . '/LINEBot/Constant/RecipientType.php';
include_once LINE_API_PATH . '/LINEBot/Constant/ContentType.php';
include_once LINE_API_PATH . '/LINEBot/Constant/OpType.php';
include_once LINE_API_PATH . '/LINEBot/Exception/LINEBotAPIException.php';
include_once LINE_API_PATH . '/LINEBot/Message/Builder/MessageBuilder.php';
include_once LINE_API_PATH . '/LINEBot/Message/Builder/MultipleMessagesBuilder.php';
include_once LINE_API_PATH . '/LINEBot/Message/Builder/RichMessageBuilder.php';
include_once LINE_API_PATH . '/LINEBot/Message/MultipleMessages.php';
include_once LINE_API_PATH . '/LINEBot/Message/RichMessage/Markup.php';
include_once LINE_API_PATH . '/LINEBot/Receive/Receive.php';
include_once LINE_API_PATH . '/LINEBot/Receive/ReceiveFactory.php';
include_once LINE_API_PATH . '/LINEBot/Response/Response.php';
include_once LINE_API_PATH . '/LINEBot/Response/FailedResponse.php';
include_once LINE_API_PATH . '/LINEBot/Response/ResponseFactory.php';
include_once LINE_API_PATH . '/LINEBot/Response/SucceededResponse.php';
include_once LINE_API_PATH . '/LINEBot/SignatureValidator.php';
include_once LINE_API_PATH . '/LINEBot/DownloadedContents.php';

...
define('FILE_SAVE_PATH', DOCUMENT_ROOT . '/Common/weixin/upload');
define("WEB_FILE_PATH",'http://'.$_SERVER['HTTP_HOST'].'/yhsci/Common/weixin/upload/');

class UploadImage
{	
	//public static $urlPath = 'http://wx.hysci.com.cn/yhsci/Common/weixin/upload/';

...
var jsbox = function(_options){
  ...
  this.show = function(){
		  ...
		  //var urlcss = $('<link rel="stylesheet" type="text/css" href="'+options_.url_css+'.css" />');
		  ...
		  var boxtitle = $('<h2 class="jsboxTitle">'+options_.title+'</h2><a href="javascript:void(0)" title="关闭" class="jsbox_close"></a>');
		  ...
		  if(options_.url != false && options_.iframe != false){
		   ...
		   $(".jsboxAn_Cancel",options).on('click',function(){
